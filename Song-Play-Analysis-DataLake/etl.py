...
def process_song_data(spark, input_data, output_data):
    """
        Description: The function reads song_data from Udacity's S3 Bucket and transforms it by extracting the songs and artist tables
        and writes them output bucket
...
def process_log_data(spark, input_data, output_data):
    """
        Description: This function reads log_data from S3 and transforms it by extracting the songs and artist tables
        and then writing them back to output location.
...
def main():
    ...
    output_data = "s3a://<Please add your bucket name>/datalake/"
